...
export const EVENTS: WowEvent[] = [
  ...
  },
  {
    ...
    description: 'This event is undocumented.  You could document it by logging in and editing this page',
    parameters: [
    ],
    category: 'Combat',
    related: [],
  ...
  },
  {
    ...
    related: [],
    patch: '3.3.5a',
    documentationUrl: 'https://web.archive.org/web/20081212162110/http://wowprogramming.com/docs/events/COMBAT_LOG_EVENT_UNFILTERED',
  },
  {
